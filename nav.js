...
(function () {
  ...
  const navCSS = `
    <style id="nav-critical-css">
      ...
      .anati-nav-links a:hover, .anati-nav-links a.active { color: #6b7563; }
      .anati-nav-links a:hover::after, .anati-nav-links a.active::after { width: 100%; }
      .anati-nav-social { display: flex; align-items: center; gap: 14px; }
      .anati-nav-social a { color: #8a8a84; display: flex; align-items: center; transition: color 0.3s; }
      .anati-nav-social a:hover { color: #87927e; }
      .anati-nav-toggle {
        display: none; flex-direction: column; gap: 5px;
        cursor: pointer; background: none; border: none; padding: 4px;
      }
      .anati-nav-toggle span { display: block; width: 22px; height: 1px; background: #2c2c2a; }
      .anati-mobile-menu {
  ...
  /* ---- FOOTER HTML ---- */
  const footerHTML = `
  <footer style="background:#2c2c2a; color:rgba(255,255,255,0.6); padding: 60px 0 40px; font-family:'Jost',sans-serif;">
    <div style="max-width:1200px; margin:0 auto; padding:0 40px;">
      <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:48px; padding-bottom:48px; border-bottom:1px solid rgba(255,255,255,0.1); margin-bottom:32px;">
        <div>
          <div style="margin-bottom:16px;">${logoWhite}</div>
          <p style="font-family:'Cormorant Garamond',serif; font-style:italic; font-size:1rem; color:rgba(255,255,255,0.4); margin-top:8px;">Journey to Infinity</p>
        </div>
        ...
        <div>
          <p style="font-family:'Cormorant Garamond',serif; font-size:1.1rem; font-style:italic; color:rgba(255,255,255,0.5); line-height:1.6;">"The quieter you become,<br>the more you are able to hear."</p>
        </div>
      </div>
      <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:16px;">
        <p style="font-size:0.75rem; color:rgba(255,255,255,0.3);">© 2024 ANATI. All rights reserved.</p>
        <div style="display:flex; gap:16px;">
          <a href="https://www.instagram.com/anatiyoga/" aria-label="Instagram" target="_blank" rel="noopener" style="color:rgba(255,255,255,0.4); display:flex; align-items:center;">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
          </a>
          <a href="https://x.com/AnatiYoga" aria-label="X" target="_blank" rel="noopener" style="color:rgba(255,255,255,0.4); display:flex; align-items:center;">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.259 5.632L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/></svg>
          </a>
          <a href="https://www.youtube.com/@anatiyoga" aria-label="YouTube" target="_blank" rel="noopener" style="color:rgba(255,255,255,0.4); display:flex; align-items:center;">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.96-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" stroke-linejoin="round"/></svg>
          </a>
        </div>
      </div>
  ...
  /* ---- Inject nav BEFORE everything else ---- */
  document.body.insertAdjacentHTML('afterbegin', navHTML);

  /* ---- Inject footer at the very end ---- */
