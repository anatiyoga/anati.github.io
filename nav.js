...
(function () {
  ...
  /* ---- FOOTER HTML ---- */
  const footerHTML = `
  <footer style="background:#3d4438;color:rgba(255,255,255,0.6);padding:60px 0 40px;font-family:'Jost',sans-serif;">
